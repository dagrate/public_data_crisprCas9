...
| CHANGE-seq data [12] | 2020 | 110 sgRNA targets across 13 therapeutically relevant loci in human primary T-cells were studied to identify 201,934 off-target sites across the human genome | Off-targets | Original Data Source: <br> [Direct Link](https://github.com/tsailabSJ/changeseq)  <br><br> Direct Link for Data Download: <br> [Github Link](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE149295) |
