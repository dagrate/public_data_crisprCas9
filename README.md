...
| Data Set 2 | [CRISPR-Cas9 by Lin and Wong 2018 [9]](http://bio.info.uqam.ca/data/lin_crispor_encoded_data.pkl), <br> [GUIDE-Seq by Tsai et al. 2015 [6]](http://bio.info.uqam.ca/data/tsai_validated_offtargets.tsv) | 8x23 <br> (Charlier et al. 2021 [10]) | [Direct Link for Download (37.4 MB)](http://bio.info.uqam.ca/data/encoded_data_charlier_et_al.pkl)
