...
| CRISPOR Database [6] | 2016 | Aggregate data for more than 50 genomes | Off-targets and On-targets | Original Data Source: <br> [Direct Link 1](http://crispor.tefor.net/) <br><br> [Direct Link 2](http://crispor.tefor.net/) <br><br> Direct Link for Data Download: <br> [Github Link](https://github.com/MichaelLinn/off_target_prediction/blob/master/data/crispor_encoded_data.pkl.zip) |
